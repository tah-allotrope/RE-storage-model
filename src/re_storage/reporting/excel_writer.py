...
TITLE_FONT = Font(name="Calibri Light", size=16, bold=True, color="1F4E79")
...
TOTAL_BORDER = Border(top=Side(style="medium", color="1F4E79"))
THIN_BORDER = Border(bottom=Side(style="thin", color="B4C6E7"))
NOTE_FONT = Font(name="Calibri", size=9, italic=True, color="808080")
CONFIDENTIAL_FONT = Font(name="Calibri", size=8, italic=True, color="808080")
...
def write_cover_sheet(
    ...
    """Write the cover sheet with project name, date, and KPI summary."""
...
def write_assessment_sheet(
    ...
    """Write an assessment sheet with KPI cards and annual proforma table."""
    import pandas as pd
